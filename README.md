...
1. **[Ghost AI](https://ghost-ai-vert-two.vercel.app)** - AI-native, real-time system-design platform (multiplayer canvas + durable AI agents)
2. **[IVCA Website](https://www.ivca.in/)** - Frontend development for Indian Venture and Alternate Capital Association
3. **[CraveWave](https://food-app-ardhendu-init.vercel.app/)** - Full-stack food delivery application with Stripe integration
4. **[Fashnest](https://fashnest.netlify.app/)** - E-commerce platform built with React and Express.js
